        ...
        $crate::reexports::smithay_macros::delegate_bundle!(
            ...
            Bundle {
                ...
                globals: [
                    ...
                    Global {
                        interface: $crate::reexports::wayland_protocols::xdg::xdg_output::zv1::server::zxdg_output_manager_v1::ZxdgOutputManagerV1,
                        data: (),
                    },
                ],
                resources: [
                    ...
                    Resource {
                        interface: $crate::reexports::wayland_protocols::xdg::xdg_output::zv1::server::zxdg_output_v1::ZxdgOutputV1,
