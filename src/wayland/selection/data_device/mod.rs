...
pub trait DataDeviceHandler:
    Sized + SelectionHandler + ClientDndGrabHandler + ServerDndGrabHandler + 'static
{
...
impl DataDeviceState {
    ...
    {
        let manager_global = display.create_delegated_global::<D, WlDataDeviceManager, _, Self>(3, ());
        ...
        fn request(
            ...
            match request {
                wl_data_device_manager::Request::CreateDataSource { id } => {
                    data_init.init_delegated::<_, _, Self>(id, DataSourceUserData::new());
                }
                    ...
                    match Seat::<D>::from_resource(&wl_seat) {
                        Some(seat) => {
                            ...
                            let device = SelectionDevice::DataDevice(
                                data_init.init_delegated::<_, _, Self>(id, DataDeviceUserData { wl_seat }),
                            );
