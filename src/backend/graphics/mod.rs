...
pub trait GraphicsBackend {
    ...
    ///
    fn set_cursor_position(&mut self, x: u32, y: u32) -> Result<(), Self::Error>;
    ...
    fn set_cursor_representation(&mut self, cursor: Self::CursorFormat, hotspot: (u32, u32)) -> Result<(), Self::Error>;
}
